...
--
-- Name: invoices_orders; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.invoices_orders (
    id bigint NOT NULL,
    uid uuid NOT NULL,
...
--
-- Name: invoices_orders_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.invoices_orders_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: invoices_orders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.invoices_orders_id_seq OWNED BY public.invoices_orders.id;
...
--
-- Name: shipments_orders; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.shipments_orders (
    id bigint NOT NULL,
    uid uuid NOT NULL,
    submitted boolean DEFAULT false
);
...
--
-- Name: shipments_orders_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.shipments_orders_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: shipments_orders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.shipments_orders_id_seq OWNED BY public.shipments_orders.id;
...
--
-- Name: invoices_orders id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.invoices_orders ALTER COLUMN id SET DEFAULT nextval('public.invoices_orders_id_seq'::regclass);
...
--
-- Name: shipments_orders id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shipments_orders ALTER COLUMN id SET DEFAULT nextval('public.shipments_orders_id_seq'::regclass);
...
--
-- Name: invoices_orders invoices_orders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.invoices_orders
    ADD CONSTRAINT invoices_orders_pkey PRIMARY KEY (id);
...
--
-- Name: shipments_orders shipments_orders_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.shipments_orders
    ADD CONSTRAINT shipments_orders_pkey PRIMARY KEY (id);
